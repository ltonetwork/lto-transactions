...
describe('cancelSponsor', () => {
  ...
  it('Should correctly serialize', () => {
    ...
    const barr = '19,1,87,26,205,53,236,36,225,249,197,208,91,167,95,7,134,151,79,89,254,109,158,209,102,127,50,190,240,113,147,22,40,192,217,1,84,145,193,229,53,69,107,116,171,107,232,58,228,4,39,243,26,134,114,65,147,175,90,181,34,0,0,1,113,27,217,220,205,0,0,0,0,29,205,101,0'
